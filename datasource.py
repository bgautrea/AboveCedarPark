...
abovecedarpark = parser['abovecedarpark']
g_driver = abovecedarpark.get('driver', DEFAULT_DRIVER)
g_data_url = parser.get('abovecedarpark', 'data_url')
g_map_url = parser.get('abovecedarpark', 'map_url')
